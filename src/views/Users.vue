<template>
  <div>
    ...
    <h1>Users Administration <UnverifiedUsersBadge v-on:error="displayErrors"></UnverifiedUsersBadge></h1>
    ...
    >
      ...
      >
        ...
        <template v-slot:cell(eclass)="data">
          <span v-if="data.item.eclass">{{data.item.eclass.description}}</span>
        </template>
...
import { BIconCheckCircleFill, BIconXCircleFill, BIconPersonPlus } from 'bootstrap-vue'
import UnverifiedUsersBadge from '../components/UnverifiedUsersBadge'

export default {
  name: 'Users',
  components: { UnverifiedUsersBadge, DynamicTableWrapper, LoadingPlaceholder, BIconCheckCircleFill, BIconXCircleFill, BIconPersonPlus },
